...
export default function Task({ id, description, title, category, priority }) {

    return (
        <div key={id} className='w-full py-2 px-3 justify-between h-24 relative bg-primary-gray rounded-md' >
            <div className='flex flex-col items-center gap-3'>
                <div className='flex items-center gap-3 w-full relative'>
                    ...
                    <div className='ml-auto w-[87%] relative'>
                        ...
                        <p className=' text-milky-dark absolute top-[100%] w-[44%] truncate-letters translate-y-1/2 line-clamp-1 '>{description}</p>
                    </div>
                </div>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex justify-between gap-1'>
                            <div className='flex items-center gap-2 justify-between'>
                                {category && <div
                                    className='h-9 flex items-center justify-center rounded-[4px] text-white'
