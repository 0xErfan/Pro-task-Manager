...
export default function Intro() {
    ...
    return (
        <section>
            ...
            {
                !loaded ?
                    <div className='flex items-center justify-center h-screen space-y-3 flex-col'>
                        <svg
                            className='size-[90px]'
